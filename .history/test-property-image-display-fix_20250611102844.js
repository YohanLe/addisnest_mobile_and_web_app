...
async function run() {
  ...
  try {
    ...
    console.log('Opening setup page in browser...');
    await open(`file://${tempHtmlPath}`);
    console.log('Browser opened. You will be redirected to account management...');
    console.log('\nCheck account management page to verify property images are displayed correctly');
    console.log('The property images should now be visible in the grid');
    
    // Wait a bit before exiting
    console.log('\nTest script complete. The browser window will remain open.');
