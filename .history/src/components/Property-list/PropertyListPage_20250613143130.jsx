          ...
          <div className="filter-grid" style={{ 
            ...
            <div className="filter-item">
              ...
              <div className="btn-group" style={{ display: 'flex', width: '100%' }}>
                <button 
                  className={`btn ${offeringType === 'For Sale' ? 'btn-primary' : 'btn-outline-primary'}`}
                  onClick={() => setOfferingType('For Sale')}
                  style={{ flex: 1, borderRadius: '10px 0 0 10px' }}
                >
                  For Sale
                </button>
                <button 
                  className={`btn ${offeringType === 'For Rent' ? 'btn-primary' : 'btn-outline-primary'}`}
                  onClick={() => setOfferingType('For Rent')}
