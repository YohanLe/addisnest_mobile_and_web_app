  ...
  const savePropertyToDatabase = async (data, plan) => {
    try {
      ...
      const formattedData = {
        ...
        offeringType: `For ${propertyForValue.charAt(0).toUpperCase() + propertyForValue.slice(1)}`, // "For Sale" or "For Rent"
        status: 'active',

        // Price as a number (required by backend)
        ...
        // Promotion type (required for backend logic)
        promotionType: plan
      };
