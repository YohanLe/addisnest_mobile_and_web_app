...
const ChoosePromotion = () => {
  ...
  const savePropertyToDatabase = async (data, plan) => {
    try {
      ...
      // Format property data for API call - CORRECTED IMPLEMENTATION 
      // Based on client-side-fix.js - COMPLETELY REMOVING status and paymentStatus fields
      const formattedData = {
        title: data.title,
        description: data.description,
        propertyType: data.propertyType,
        offeringType: data.offeringType,
        // CORRECT FIX: Completely removed status and paymentStatus fields
