  ...
  const savePropertyToDatabase = async (data, plan) => {
    try {
      ...
      const formattedData = {
        ...
        // The field in PropertyListForm is still named property_address even though the UI label is "Street Name"
        street: data.street || data.property_address || data.address?.street || "",
        city: data.city || data.address?.city || "",
        regional_state: data.regional_state || data.address?.state || "",
