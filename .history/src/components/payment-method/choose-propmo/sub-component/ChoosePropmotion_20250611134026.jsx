...
const ChoosePromotion = () => {
  ...
  const createMockPropertyData = () => {
    ...
    return {
      ...
      price: 5000000,
      property_type: "House", // Legacy field name
      property_for: "For Sale", // Legacy field name
      total_price: 5000000, // Legacy field name
      property_address: "Test Address, Addis Ababa",
      street: "Test Address, Addis Ababa", // Explicit street field
      number_of_bedrooms: "3",
      bedrooms: 3, // Explicit bedrooms field
      number_of_bathrooms: "2",
      bathrooms: 2, // Explicit bathrooms field
      property_size: "250",
      area: 250, // Explicit area field
      description: "Test property created in test mode",
      city: "Addis Ababa",
      regional_state: "Addis Ababa City Administration",
      country: "Ethiopia",
      amenities: ["Parking", "Security", "Garden"],
      features: { // Explicit features object
        "parking-space": true,
        "24-7-security": true,
        "gym-fitness-center": true
      },
      furnishing: "Unfurnished",
      furnishingStatus: "Unfurnished", // Explicit furnishingStatus field
      media_paths: ["https://via.placeholder.com/300x200?text=Test+Property"],
      images: DEFAULT_IMAGES // Always include default images in test mode
    };
  };
    ...
    try {
      ...
      const formattedData = {
        ...
        features: Object.keys(features).length > 0 ? features : {
          "hasPool": true, // Changed to match new schema format
          "parking-space": true,
          "24-7-security": true
        },
        // UPDATED FIX: Use only flat top-level address fields as required by the updated MongoDB schema
        // These address fields must be directly on the property object, not nested
  ...
  // No required field validation here; assume property form enforces required fields before navigation.
    ...
    // We'll do this for all submissions, not just when city is missing
    ...
    console.log("Address structure prepared:", {
      flat: { street, city, state, country },
