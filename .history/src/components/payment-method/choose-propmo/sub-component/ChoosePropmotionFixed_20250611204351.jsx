  ...
  const savePropertyToDatabase = async (data, plan) => {
    try {
      ...
      const formattedData = {
        ...
        street: data.street || data.property_address || (data.address && data.address.street) || "Unknown Street",
        city: data.city || (data.address && data.address.city) || "Unknown City",
        state: data.regional_state || (data.address && data.address.state) || "Unknown State",
