        ...
        <div style={{ flex: '1', minWidth: '300px' }}>
          ...
          <div style={{ marginBottom: '25px' }}>
            ...
            <input
              ...
              placeholder="e.g., Fixed, ARM, FHA, VA"
              style={{
                width: '100%',
                padding: '12px 15px',
                border: '1px solid #ddd',
          ...
          <div style={{ 
                ...
                <PieChart width={300} height={200}>
                  ...
                  >
                    {chartData.map((entry, index) => (
                      <Cell key={`cell-ETB{index}`} fill={COLORS[index % COLORS.length]} />
                    ))}
                  </Pie>
            ...
            <div style={{ 
              ...
              <div style={{ 
                ...
                <span>{currency}{totalMonthlyPayment.toLocaleString(undefined, {maximumFractionDigits: 2})}</span>
              </div>
            </div>
