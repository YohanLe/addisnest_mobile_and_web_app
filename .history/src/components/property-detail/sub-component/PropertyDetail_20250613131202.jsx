                    ...
                    <div className="col-md-7" style={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div className="property-info-box" style={{
                            ...
                            <div>
                                ...
                                {/* Property Description and Action Buttons */}
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', minWidth: '180px' }}>
                                        ...
                                        >
                                            <span style={{ fontSize: '16px', marginRight: '8px' }}>💰</span> Buy Property
                                        </button>
                                        <button 
                                            style={{
                                                backgroundColor: '#4CAF50',
                                        ...
                                        >
                                            <span style={{ fontSize: '16px', marginRight: '8px' }}>📝</span> Post Ad
                                        </button>
                                        <button 
                                            style={{
                                        ...
                                        >
                                            <span style={{ fontSize: '16px', marginRight: '8px' }}>🔒</span> Mark
                                        </button>
                                        <button 
                                            style={{
                                        ...
                                        >
                                            <span style={{ fontSize: '16px', marginRight: '8px' }}>🚩</span> Report
                                        </button>
                                    </div>
                                </div>
