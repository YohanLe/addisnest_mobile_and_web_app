                            ...
                            <div>
                                ...
                                <div style={{ marginTop: '25px' }}>
                                    ...
                                    <div style={{ 
                                        ...
                                        {PropertyDetails?.features?.parking_space && (
                                            <div style={{ 
                                                display: 'flex', 
                                                alignItems: 'center',
                                        ...
                                        {PropertyDetails?.features?.garage && (
                                            <div style={{ 
                                                display: 'flex', 
                                                alignItems: 'center',
                                                backgroundColor: '#f8f9fa',
                                        ...
                                        {PropertyDetails?.features?.['24-7_security'] && (
                                            <div style={{ 
                                                display: 'flex', 
                                                alignItems: 'center',
                                                backgroundColor: '#f8f9fa',
                                        ...
                                        {PropertyDetails?.features?.cctv_surveillance && (
                                            <div style={{ 
                                                display: 'flex', 
                                                alignItems: 'center',
                                                backgroundColor: '#f8f9fa',
                                        ...
                                        {PropertyDetails?.features?.gym_fitness_center && (
                                            <div style={{ 
                                                display: 'flex', 
                                                alignItems: 'center',
                                                backgroundColor: '#f8f9fa',
                                        ...
                                        {PropertyDetails?.features?.swimming_pool && (
                                            <div style={{ 
                                                display: 'flex', 
                                                alignItems: 'center',
                                                backgroundColor: '#f8f9fa',
                                        ...
                                        {/* Fallback message if no features are defined */}
                                        {!PropertyDetails?.features || 
                                         (typeof PropertyDetails?.features === 'object' && 
                                          Object.keys(PropertyDetails?.features).length === 0) && (
                                            <div style={{ 
                                                gridColumn: '1 / -1',
                                                padding: '12px',
                                                color: '#666',
