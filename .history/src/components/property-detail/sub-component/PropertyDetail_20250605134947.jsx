                            ...
                            <div>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', marginBottom: '12px' }}>
                                    ...
                                    <span style={{ 
                                        ...
                                        {PropertyDetails?.status?.toUpperCase() || 'FOR SALE'} - <span style={{ 
                                ...
                                <h1 style={{ 
                                    ...
                                    {PropertyDetails?.address || PropertyDetails?.location?.address || '1207 SW 182nd Ave, Beaverton, OR 97003'}
                                </h1>
                                ...
                                <div style={{ marginBottom: '20px' }}>
                                    <h2 style={{ 
                                        ...
                                        {formatPrice(PropertyDetails?.price || 450000)}
                                    </h2>
                                    <p style={{ margin: '0 0 5px 0', fontSize: '15px', color: '#666' }}>
                                        Est. {PropertyDetails?.currency || ''}{Math.round((PropertyDetails?.price * 0.005) || 2798)}/mo
                                    </p>
                                </div>
                                ...
                                <div style={{ marginBottom: '20px' }}>
                                    <p style={{ 
                                        ...
                                        Welcome to this beautiful family home in the heart of a peaceful neighborhood. This spacious property offers modern living with traditional charm, making it perfect for families looking for comfort and convenience.
                                    </p>
                                </div>
                                ...
                                <div style={{ 
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'flex-start' }}>
                                        ...
                                        <div>
                                            ...
                                            <div>{PropertyDetails?.propertyType || 'House'}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'flex-start' }}>
                                        ...
                                        <div>
                                            ...
                                            <div>{PropertyDetails?.bedrooms || PropertyDetails?.specifications?.bedrooms || 3}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'flex-start' }}>
                                        ...
                                        <div>
                                            ...
                                            <div>{PropertyDetails?.bathrooms || PropertyDetails?.specifications?.bathrooms || 2}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'flex-start' }}>
                                        ...
                                        <div>
                                            ...
                                            <div>{PropertyDetails?.size || PropertyDetails?.specifications?.area?.size || 250} sqm</div>
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'flex-start' }}>
                                        ...
                                        <div>
                                            <div style={{ fontWeight: '600', color: '#555', marginBottom: '4px' }}>Heating & AC</div>
                                            <div>{PropertyDetails?.heatingAndCooling || 'Not available'}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
