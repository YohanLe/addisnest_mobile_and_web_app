...
const PropertyDetail = ({ PropertyDetails, similarProperties }) => {
    ...
    // Create sample nearby properties if none are provided
    const nearbyProperties = similarProperties && similarProperties.length > 0 ? similarProperties : [
        {
            id: "prop1",
            title: "Modern Apartment in City Center",
            price: 12500000,
            beds: 3,
            specifications: { bathrooms: 2, area: { size: 180 } },
            property_size: 180,
            status: "For Sale",
            createdAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000), // 3 days ago
            media: ["https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3"],
            location: { address: "Bole, Addis Ababa" },
            is_wishlist: false
        },
        {
            id: "prop2",
            ...
            price: 18700000,
            beds: 4,
            specifications: { bathrooms: 3, area: { size: 250 } },
            property_size: 250,
            status: "For Sale",
            createdAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000), // 5 days ago
            media: ["https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3"],
            location: { address: "CMC, Addis Ababa" },
            is_wishlist: true
        },
        {
            id: "prop3",
            ...
            price: 9800000,
            beds: 3,
            specifications: { bathrooms: 2, area: { size: 160 } },
            property_size: 160,
            status: "For Sale",
            createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000), // 7 days ago
            media: ["https://images.unsplash.com/photo-1604014237800-1c9102c219da?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3"],
            location: { address: "Sarbet, Addis Ababa" },
            is_wishlist: false
        },
        {
            id: "prop4",
            ...
            price: 22000000,
            beds: 4,
            specifications: { bathrooms: 3, area: { size: 220 } },
            property_size: 220,
            status: "For Sale",
            createdAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000), // 2 days ago
            media: ["https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3"],
            location: { address: "Kazanchis, Addis Ababa" },
            is_wishlist: false
        },
        {
            id: "prop5",
            ...
            price: 7500000,
            beds: 2,
            specifications: { bathrooms: 1, area: { size: 120 } },
            property_size: 120,
            status: "For Sale",
            createdAt: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000), // 10 days ago
            media: ["https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3"],
            location: { address: "Piassa, Addis Ababa" },
            is_wishlist: false
        },
        {
            id: "prop6",
            title: "Modern G+2 House",
            price: 15300000,
            beds: 5,
            specifications: { bathrooms: 4, area: { size: 300 } },
            property_size: 300,
            status: "For Sale",
            createdAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000), // 1 day ago
            media: ["https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3"],
            location: { address: "Summit, Addis Ababa" },
            is_wishlist: true
        }
    ];
