            ...
            <div className="container" style={{ marginBottom: '50px' }}>
                <div className="featured-properties">
                    ...
                    <div style={{ 
                        ...
                        {/* Use properties from the property list */}
                        {similarProperties && similarProperties.slice(0, 3).map((property, index) => (
                            <div key={index} style={{ 
                                width: '100%', 
                                maxWidth: '380px',
                                borderRadius: '8px',
                                ...
                                <div style={{ 
                                    ...
                                    <div style={{ 
                                        ...
                                        top: '15px',
                                        left: '15px',
                                        backgroundColor: property.property_for === 'rent' ? '#2563eb' : '#059669',
                                        color: 'white',
                                        padding: '5px 12px',
                                        borderRadius: '4px',
                                        fontSize: '13px',
                                    ...
                                    {/* Property Image */}
                                    <img 
                                        src={property.media?.[0] || "https://images.unsplash.com/photo-1518780664697-55e3ad937233?q=80&w=765&auto=format&fit=crop"} 
                                        alt="Property" 
                                        style={{ 
                                            width: '100%',
                                            height: '100%',
                                ...
                                <div style={{ padding: '20px' }}>
                                    ...
                                    <div style={{ 
                                        ...
                                        <h3 style={{ 
                                            ...
                                            {new Intl.NumberFormat('en-US').format(property.total_price || property.price || 0)}
                                        </h3>
                                        <div style={{ 
                                            display: 'flex',
                                            gap: '8px'
                                    ...
                                    <p style={{ 
                                        ...
                                        {property.property_address || 
                                         property.address || 
                                         (property.city && property.regional_state ? 
                                          `${property.city}, ${property.regional_state}, ${property.country || 'Ethiopia'}` : 
                                    ...
                                    <div style={{ 
                                        ...
                                        <div style={{ 
                                            ...
                                            {property.number_of_bedrooms || property.bedrooms || property.specifications?.bedrooms || 0} beds
                                        </div>
                                        <div style={{ 
                                            fontSize: '14px',
                                            color: '#4a5568'
                                        }}>
                                            {property.number_of_bathrooms || property.bathrooms || property.specifications?.bathrooms || 0} baths
                                        </div>
                                        <div style={{ 
                                            fontSize: '14px',
                                            color: '#4a5568'
                                        }}>
                                            {property.property_size || property.size || property.specifications?.area?.size || 0} sqm
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ 
                                        ...
                                        {property.agent?.name || property.agent_name || "Addisnest Agent"}
                                    </div>
                                </div>
                            </div>
                        ))}
                        
                        {/* Display default property cards if no similarProperties */}
                        {(!similarProperties || similarProperties.length === 0) && (
                            <>
                                {/* Default Property Card 1 */}
                                <div style={{ 
                                    width: '100%', 
                                    maxWidth: '380px',
                                    borderRadius: '8px',
                                    ...
                                    <div style={{position: 'relative', height: '250px', overflow: 'hidden'}}>
                                        <div style={{position: 'absolute', top: '15px', left: '15px', backgroundColor: '#059669', color: 'white', padding: '5px 12px', borderRadius: '4px', fontSize: '13px', fontWeight: '600', zIndex: '2'}}>
                                            FOR SALE
                                        </div>
                                        <div style={{position: 'absolute', top: '15px', right: '15px', backgroundColor: 'rgba(0,0,0,0.6)', color: 'white', padding: '5px 10px', borderRadius: '4px', fontSize: '13px', fontWeight: '500', zIndex: '2'}}>
                                            2023
                                        </div>
                                        <img src="https://images.unsplash.com/photo-1518780664697-55e3ad937233?q=80&w=765&auto=format&fit=crop" alt="Property" style={{width: '100%', height: '100%', objectFit: 'cover'}} />
                                    </div>
                                    <div style={{padding: '20px'}}>
                                        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px'}}>
                                            <h3 style={{fontSize: '24px', fontWeight: '700', color: '#1a202c', margin: '0'}}>$450,000</h3>
                                        </div>
                                        <p style={{fontSize: '16px', fontWeight: '500', color: '#4a5568', marginBottom: '15px'}}>
                                            Sample Address, City, Ethiopia
                                        </p>
                                        <div style={{display: 'flex', gap: '15px', marginBottom: '15px'}}>
                                            <div style={{fontSize: '14px', color: '#4a5568'}}>3 beds</div>
                                            <div style={{fontSize: '14px', color: '#4a5568'}}>2 baths</div>
                                            <div style={{fontSize: '14px', color: '#4a5568'}}>150 sqm</div>
                                        </div>
                                    </div>
                                </div>
                            </>
