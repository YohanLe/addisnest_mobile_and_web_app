...
const PropertyListForm = () => {
    ...
    const validateForm = () => {
        ...
        // Skip image validation per client request - allow users to continue with any number of images
        // Note: We'll still display the image upload UI but won't block submission
