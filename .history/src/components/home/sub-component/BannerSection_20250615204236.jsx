...
import { applyFilters } from '../../../utils/propertyFilters';
              ...
              <div className="search-tabs-container">
                ...
                <div style={{ marginTop: '15px', textAlign: 'center' }}>
                  <button 
                    className="btn" 
                    onClick={() => {
                      // Use the filter utility with the appropriate offering type
                      const offeringType = searchType === 'for-rent' ? 'For Rent' : 'For Sale';
                      applyFilters(navigate, { offeringType });
                    }}
                    style={{
                      display: 'inline-flex',
                      alignItems: 'center',
