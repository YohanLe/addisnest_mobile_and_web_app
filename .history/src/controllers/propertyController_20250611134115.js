  ...
  submitPropertyPending = this.asyncHandler(async (req, res) => {
    try {
      ...
      if (req.body.address && typeof req.body.address === 'object') {
        ...
        // Ensure address fields exist at top level
        req.body.street = req.body.street || req.body.property_address || "Unknown Street";
        req.body.city = req.body.city || "Unknown City";
        req.body.state = req.body.state || req.body.regional_state || "Unknown State";
        req.body.country = req.body.country || "Ethiopia";
      }
      
      // Remove legacy fields that are not in the updated schema
      delete req.body.paymentStatus;
      delete req.body.property_address;
      delete req.body.regional_state;
      
      // Ensure features has the correct format for the updated schema
      if (!req.body.features || typeof req.body.features !== 'object') {
        req.body.features = { hasPool: false };
      }
