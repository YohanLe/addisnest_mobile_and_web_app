...
console.log('Agent routes:', Object.keys(routes.agentRoutes.stack.map(r => r.route)).length);
app.use('/api/agents', routes.agentRoutes);
console.log('User routes:', Object.keys(routes.userRoutes.stack.map(r => r.route)).length);
app.use('/api/users', routes.userRoutes);
console.log('Auth routes:', Object.keys(routes.authRoutes.stack.map(r => r.route)).length);
