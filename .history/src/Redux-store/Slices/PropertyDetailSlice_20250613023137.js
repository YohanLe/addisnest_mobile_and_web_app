    ...
    try {
      ...
      try {
        ...
        const transformedData = {
          ...
          propertyType: apiData.property_type || apiData.propertyType || 'House',
          ...
          bedrooms: apiData.number_of_bedrooms || apiData.bedrooms || 0,
          beds: apiData.number_of_bedrooms || apiData.bedrooms || 0,
          
          number_of_bathrooms: apiData.number_of_bathrooms || apiData.bathrooms || 0,
          bathrooms: apiData.number_of_bathrooms || apiData.bathrooms || 0,
          bathroom_information: Array(apiData.number_of_bathrooms || apiData.bathrooms || 0).fill({}),
          
          furnishing: apiData.furnishing || 'Not specified',
          ...
          // Additional data
          promotion_package: apiData.promotion_package || apiData.promotionType || 'basic',
          ...
          media: apiData.media_paths || 
                 (apiData.images?.map && apiData.images?.map(img => typeof img === 'string' ? img : img.url)) || 
                 (Array.isArray(apiData.media) ? apiData.media : []) || 
                 mockProperties[0].media, // Fallback to mock property images if none found
          
          // Copy original media_paths for debugging
