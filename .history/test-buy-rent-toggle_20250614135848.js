/**
 * Test Script for Buy/Rent Toggle Button Functionality
 * 
 * This script provides a way to test the Buy/Rent toggle functionality 
 * on the homepage banner section.
 */
...
console.log('=================================================');
console.log('\nThis script will help verify the Buy/Rent toggle button works correctly.');
  ...
  exec('taskkill /im node.exe /f', (error) => {
    ...
    startProcess.stdout.on('data', (data) => {
      ...
      if (data.includes('Server running') || data.includes('running at http://localhost')) {
        ...
        console.log('2. Locate the "Buy/Rent" toggle button in the banner section');
