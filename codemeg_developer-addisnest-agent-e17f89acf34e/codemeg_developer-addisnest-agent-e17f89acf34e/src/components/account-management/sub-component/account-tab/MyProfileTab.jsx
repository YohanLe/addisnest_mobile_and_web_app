                    ...
                    <div className="form-flex">
                        ...
                        <div className="form-inner-flex-50">
                            <div className="single-input">
                                ...
                                />
                                 {error.errors?.address && <p className="error-input-msg">{error.errors?.address}</p>}
                            </div>
                        </div>
                        <div className="form-inner-flex-50">
                            <div className="single-input">
                        ...
                        <div className="form-inner-flex-50">
                            <div className="single-input">
                                ...
                                />
                                 {error.errors?.state && <p className="error-input-msg">{error.errors?.state}</p>}
                            </div>
                        </div>
                        <div className="form-inner-flex-50">
                            <div className="single-input">
                        ...
                        {/* <div className="form-inner-flex-50">
                            <div className="single-input">
                                <label for="">Regional State</label>
