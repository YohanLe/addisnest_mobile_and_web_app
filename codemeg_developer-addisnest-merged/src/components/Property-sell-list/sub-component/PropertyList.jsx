...
import PropertyOnlyList from "../../property-list/sub-component/property-list-tab/PropertyOnlyList";
            ...
            <section className="property-list-section">
                <div className="container-fluid">
                    <div className="property-list-detail">
                        <PropertyOnlyList HomeList={sortedHomeList}/>
                    </div>
                </div>
            </section>
            {showFilterPopup && (
